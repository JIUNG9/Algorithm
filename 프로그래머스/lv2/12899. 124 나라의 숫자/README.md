...
### Approach
124 나라는 3진법과 비슷하지만 나누어 떨어질 때의 경우를 다르게 처리해야한다. 3진법은 나누어 떨어진다면 자리 수가 올라간다. 예시로
3이라는 10진법 숫자는 3진법으로 10이 되지만 124나라의 숫자로는 4가 된다. 6이라는 숫자는 3진법으로 20이지만 124나라의 숫자로는 14가 된다. 규칙성을 파악한다면 몫은 1이 줄고 나누어 떨어진다면 124 나라에서는 4라는 숫자를 0대신에 쓴다.
