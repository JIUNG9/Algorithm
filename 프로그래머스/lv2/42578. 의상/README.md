...
### Approach
의상의 종류의 개수를 구하고 해당 종류의 옷이 몇 개가 존재하는지 확인한다. 그리고 해당 종류의 옷의 가지 수를 확인하고 입지 않은 경우의 수를 고려한다. 이를 구현하기 위해 Map interface를 사용하고 모두 입지 않은 경우의 수는 제외하기 위해서 결과값에서 -1를 한다.
