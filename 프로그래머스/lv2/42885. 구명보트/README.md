...
### Approach
해당 문제는 투포인터 방식으로 접근해야하기 때문에 Deque를 사용해서 해결하였다. 만약 정렬된 디큐에서 가장 뚱뚱한 사람과 가장 마른 사람의 합이 limit를 넘지 않는다면 지속적으로 그 다음 마른 사람을 체크해서 배에 태울 수 있는지 확인하며 가장 적은 배를 사용할 수 있는 방법을 찾는다.

### 성능 요약

메모리: 55.5 MB, 시간: 28.46 ms
