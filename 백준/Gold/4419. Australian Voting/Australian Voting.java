...
public class Main {
  ...
  public static void main(String args[]) throws IOException {
    ...
    while (true) {
      ...
      List<Entry<String, Integer>> entryList = new LinkedList<>(candidates.entrySet());
      ...
      if (max > 50 || minValue == maxValue) {
        ...
        for (int i = entryList.size() - 1; i >= 0; i--) {
          ...
          if (i == 0 || entryList.get(i).getValue() != entryList.get(i - 1).getValue())
            break;
        }
      ...
      for (int i = 0; i < entryList.size() - 1; i++, idx--) {
        ...
        if (minValue != entryList.get(0).getValue())
          break;
      }
    }
  ...
  public static void findNextVote(int[][] votes, int idx, ArrayList<String> nameList,
      int minValue) {
